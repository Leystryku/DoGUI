...
private:
	...
	bool desiredcaretmoved;
	bool desiredcaretchanged;
	bool addoldcaretcords;
	int8_t desiredcaretset;
	size_t desiredcaretx;
	size_t desiredcarety;
...
public:
	...
	virtual bool GetTextBeingMarked();
	virtual bool GetAllTextBeingMarked();
	virtual int32_t SetTextBeingMarked(bool marked);
	...
	virtual int32_t SetCaretOldIndex(size_t caretpos);
	virtual size_t GetCaretOldIndex();
